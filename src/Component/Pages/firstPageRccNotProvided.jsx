    ...
    return (
        ...
        <div>
            ...
            <Card cardTitle={"Results"} status={callDxp}>
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialDropDownPavedOrGravel === "PAVED" && rcc.result != 0 && allPavedRunwayConditionDescription.includes('Dry Snow more than 1.0 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialDropDownPavedOrGravel === "GRAVEL" && rcc.result != 0 && allGravelRunwayConditionDescription.includes('Dry Snow more than 1.0 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                            Max Dry Snow Depth = 2.0 in
                        </div>
                    )}
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "DHC-8" && rcc.result != 0 && rcc.totalPercentage < 40 && initialDropDownPavedOrGravel === "GRAVEL" &&
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "HS-748" && rcc.result != 0 && rcc.totalPercentage < 40 && initialDropDownPavedOrGravel === "GRAVEL" &&
                        allGravelRunwayConditionDescription.includes('Wet Snow greater than 0.13 in depth over Compacted snow/gravel mix') && (
                            <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "DHC-8" && initialDropDownPavedOrGravel === "PAVED" && rcc.result != 0 && allRunwayConditionDescription.includes('Wet Snow greater than 0.13 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                            Max Wet Snow Depth = 1.0 in
                        </div>
                    )}
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "HS-748" && initialDropDownPavedOrGravel === "PAVED" && rcc.result != 0 && allRunwayConditionDescription.includes('Wet Snow greater than 0.13 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                            Max Wet Snow Depth = 0.5 in
                        </div>
                    )}
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "DHC-8" && initialDropDownPavedOrGravel === "PAVED" && rcc.result != 0 && allRunwayConditionDescription.includes('Water Greater than 0.13 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "DHC-8" && initialDropDownPavedOrGravel === "GRAVEL" && rcc.result != 0 && allRunwayConditionDescription.includes('Water Greater than 0.13 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                            Max Water Depth = 0.5 in
                        </div>
                    )}
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "DHC-8" && initialDropDownPavedOrGravel === "PAVED" && rcc.result != 0 && allRunwayConditionDescription.includes('Slush Greater than 0.13 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                ...
                <div style={{ marginBottom: '10px' }}>
                    {initialAircraftType === "HS-748" && initialDropDownPavedOrGravel === "PAVED" && rcc.result != 0 && allRunwayConditionDescription.includes('Slush Greater than 0.13 in depth') && (
                        <div className="flex flex-row bg-orange-400 rounded-md p-2 text-white justify-center items-center">
                            Max Slush Depth = 0.5 in
                        </div>
                    )}
